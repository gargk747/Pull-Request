package com.example.pullrequest.view
...
import com.example.pullrequest.util.getProgressDrawable
import com.example.pullrequest.util.loadImage
...
class PullRequestAdapter(var pullRequest: ArrayList<PullRequest>):RecyclerView.Adapter<PullRequestAdapter.PullListRequestViewHolder>() {
   ...
   class PullListRequestViewHolder(view: View): RecyclerView.ViewHolder(view) {
      ...
      fun bind(pullRequest: PullRequest) {
         ...
         created_date.text = pullRequest.created_date?.subSequence(0,10) ?: pullRequest.created_date
         closed_date.text = pullRequest.closed_date?.subSequence(0,10)?:pullRequest.closed_date
